...
void Misc::killMessage(GameEvent& event) noexcept
{
    ...
    {
    case 0:
        killMessage = skCrypt("by Medusa.uno");
        break;
    case 1:
        killMessage = skCrypt("why you miss?");
        break;
    case 2:
        killMessage = skCrypt("1");
        break;
    case 3:
        killMessage = skCrypt("why you die to a €5 cheat bro AHAHAH");
        break;
    case 4:
        killMessage = skCrypt("You just got shit on by Medusa.Uno you should convert over to the better side");
        break;
    case 5:
        killMessage = skCrypt("You should have bought the Premium Package with your cheat you just got 1");
        break;
    case 6:
        killMessage = skCrypt("wyd?");
        break;
    case 7:
        killMessage = skCrypt("");
        break;
...
void Misc::playHitSound(GameEvent& event) noexcept
{
    ...
    if (config->misc.hitSound == 0)
        ...
        interfaces->engine->clientCmdUnrestricted(c_xor("play physics/shield/bullet_hit_shield_01"));
    else if (config->misc.hitSound == 8)
        interfaces->engine->clientCmdUnrestricted(c_xor("play physics/metal/paintcan_impact_hard3.wav"));
    else if (config->misc.hitSound == 9)
...
void Misc::killSound(GameEvent& event) noexcept
{
    ...
    if (config->misc.killSound == 0)
        ...
        interfaces->engine->clientCmdUnrestricted(c_xor("play physics/shield/bullet_hit_shield_01"));
    else if (config->misc.killSound == 8)
        interfaces->engine->clientCmdUnrestricted(c_xor("play physics/metal/paintcan_impact_hard3.wav"));
    else if (config->misc.killSound == 9)
