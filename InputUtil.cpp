...
bool KeyBind::isOff() const noexcept
{
    if (keyMode == KeyMode::Off)
        return true;
    else
        return false;
}
...
bool KeyBind::isActive2() const noexcept
{
    switch (keyMode)
    {
    case KeyMode::Off:
